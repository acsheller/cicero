...
class LLMRater(ABC):
    ...
    def query(
        ...
        Args:
            ...
            interactions (list of UserMovNewsieInteraction): the previous interactions
            retrieved_items (list of News Articles): the retrieved items
    ...
    def queryMind(
        ...
        Args:
            ...
            item (News): the item
            num_interacted (int): the number of times the item has been watched
            interactions (list of UserNewsInteraction): the previous interactions
            retrieved_items (list of News): the retrieved items
