...
class ThirdPersonDescriptive110_OurSys(LLMRater):
    def __init__(
        ...
        self.system_prompt = (
            ...
            " accurate ratings for news on a scale of 1 to 10, ensuring they resonate"
...
########
    ...
    def _get_prompt(
        ...
        prompt = (
            ...
            + (
                f'On average, the new article has a click-through rate of {news.click_through_rate} and ' # TODO Need to work on the behaviors to see and count impressions and such
            ...
            f' "{news.title}" on a scale of 1 to 10, where 1 represents a low rating'
