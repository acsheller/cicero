    ...
    def _get_few_shot_prompts(self):
        if self.cache_few_shot_prompts is None:
            ...
            explanation1 = (
                ...
                " Prince Philip Swear By' a 3 on a scale of 1 to 10. Despite his primary interest in"
...
class ThirdPersonDescriptive09_2Shot_OurSys_large(ThirdPersonDescriptive09_OurSys):
    def __init__(
        self,
        llm: LLM,
        current_items_features_list,
