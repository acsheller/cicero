...
class ThirdPersonDescriptive110_1Shot_OurSys_large(ThirdPersonDescriptive110_OurSys):
    '''
    Specified large because there are differences between small and large
    '''
    def __init__(
        self,
        llm: LLM,
