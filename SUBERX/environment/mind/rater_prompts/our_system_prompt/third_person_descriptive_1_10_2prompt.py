...
class ThirdPersonDescriptive110_2Shot_OurSys(ThirdPersonDescriptive110_OurSys):
    def __init__(
        self,
        llm: LLM,
    ...
    def _get_few_shot_prompts(self):
        if self.cache_few_shot_prompts is None:
            ...
            explanation1 = (
                ...
                " Prince Philip Swear By' a 4 on a scale of 1 to 10. Despite his primary interest in"
                ...
                " him, leading him to rate it a 4."
            )
...
class ThirdPersonDescriptive110_2Shot_OurSys_large(ThirdPersonDescriptive110_OurSys):
    def __init__(
        self,
        llm: LLM,
        current_items_features_list,
