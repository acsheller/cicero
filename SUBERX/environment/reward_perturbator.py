...
class RewardPerturbatorMind(ABC):
    """
    ...
    @abstractmethod
    def perturb(
        self, items: typing.List[News], ratings: typing.List[int]
...
class GreedyPerturbatorMind(RewardPerturbatorMind):
    """
...
class GaussianPerturbatorMind(RewardPerturbatorMind):
    """
...
class NoPerturbatorMind(RewardPerturbatorMind):
    """
