...
class RewardShapingMind(ABC):
    ...
    def reshape(
        self,
        item_interactions: typing.List[UserNewsInteraction],
        rating: int,
...
class IdentityRewardShapingMind(RewardShapingMind):
    def __init__(self, stepsize=0.5, min_rating=1, max_rating=10, seed=42):
        super().__init__(stepsize, min_rating, max_rating, seed)

    def reshape(
        self, item_interactions: typing.List[UserNewsInteraction], rating: int
    ) -> float:
        return rating, False

class RewardReshapingExpDecayTimeMind(RewardShapingMind):
...
class RewardReshapingRandomWatchMind(RewardShapingMind):
    def __init__(self, q=0.1, stepsize=0.5, min_rating=1, max_rating=10, seed=42):
        self.q = q
        super().__init__(stepsize, min_rating, max_rating, seed)
...
class RewardReshapingTerminateIfSeenMind(RewardShapingMind):
    def __init__(self, q=0.1, stepsize=0.5, min_rating=1, max_rating=10, seed=42):
        self.q = q
        super().__init__(stepsize, min_rating, max_rating, seed)
